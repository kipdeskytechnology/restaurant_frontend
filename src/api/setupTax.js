...
export const deleteTaxRate = (id) => http.delete(`/setup/tax/rates/${id}`).then(r => r.data);
...
export const deleteTaxProfile = (id) => http.delete(`/setup/tax/profiles/${id}`).then(r => r.data);
